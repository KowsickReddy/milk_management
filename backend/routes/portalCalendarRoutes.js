// ── Portal Calendar Routes ───────────────────────────────────────────────
// Monthly delivery calendar for customer portal
...
// GET /api/portal/calendar/:customerId?year=2026&month=7
router.get('/:customerId', requireSelfOrStaff('customerId'), asyncHandler(async (req, res) => {
  ...
  // Build a map: date -> { status, quantity, extra, shifts[] }
  const calendar = {};
  ...
  // Also check long leaves (leave_requests) that overlap this month
